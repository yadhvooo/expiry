...
import { ShieldCheck, Heart, Sparkles, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <main className="flex-1">
        ...
        {currentView === 'provider-dashboard' && <ProviderDashboardPage setView={setCurrentView} />}
        {currentView === 'provider-products' && <ProviderProductsPage />}
        {currentView === 'provider-orders' && <ProviderOrdersPage />}
